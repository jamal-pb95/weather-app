...
var quoteArray = [
  {"author":"Bill Sempf","id":44,"quote":"QA Engineer walks into a bar. Orders a beer. Orders 0 beers. Orders 999999999 beers. Orders a lizard. Orders -1 beers.","permalink":"http://quotes.stormconsultancy.co.uk/quotes/44"},
...
document.getElementById('quote-area').innerHTML = quoteArray[1].quote;
document.getElementById('author').innerHTML = quoteArray[1].author;
function newQuote() {
	var randomNumber = Math.floor(Math.random() * (quoteArray.length));
	 document.getElementById('quote-area').innerHTML = quoteArray[randomNumber]["quote"];
